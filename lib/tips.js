module.exports = [
  ...
  'Everything Atom-ng can do is in the Command Palette. See it by using {command-palette:toggle}',
  ...
  'You can open a webview pane with {atom-browser:showHide}',
  'You can toggle the minimap overlay with {minimap:toggle}',
